...
def option():
    ...
    parser.add_argument('--input_nc', type=int, default=0, help='num of input channels')
    parser.add_argument('--output_nc', type=int, default=0, help='num of output channels')
    parser.add_argument('--padding_type', type=str, default='reflect', help='padding type')
    parser.add_argument('--res_num', type=int, default=6, help='num of res block')
